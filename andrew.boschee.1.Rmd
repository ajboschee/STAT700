...
# Updated PlotCookingTooMuch variables from using CaloriesPerRecipe to CaloriesPerServing
...
Reference values do not match comp values due to error by Wassink regarding mean values
...
From this plot, it appears that average calories per recipe changed very little from 1936 to 1997. This suggests that the signficant increase from 1936 to 2006 reported by Wansink is due to an increase in the 2006 recipes only. Thus, we only need to compare 1936 and 2006 recipe sets. 
